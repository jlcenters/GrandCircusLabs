...
public class Validator {
	...
	public static String getYesNo(Scanner scnr, String prompt) {
		...
		do {
			...
			if (input.equalsIgnoreCase("yes") || input.equalsIgnoreCase("y") || input.equalsIgnoreCase("no") || input.equalsIgnoreCase("n")) {
				isValid = true;
			} else {
				System.out.println("Please use a yes or no format.");
				isValid = false;
			}
